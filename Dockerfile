...
RUN    wget  http://www-us.apache.org/dist//ignite/2.6.0/apache-ignite-2.6.0-bin.zip
RUN    unzip -q apache-ignite-2.6.0-bin.zip
RUN     mv apache-ignite-2.6.0-bin IGNITE-2_6
